...
public class Game extends BaseGameActivity {
    ...
    public synchronized void onResumeGame() {
        ...
        if (getSharedPreferences("RadiantInvaders", MODE_PRIVATE).getBoolean("isMusicEnabled", true)) {
    ...
    public EngineOptions onCreateEngineOptions() {
        EngineOptions engineOptions = new EngineOptions(true, ScreenOrientation.LANDSCAPE_FIXED, new FillResolutionPolicy(), new Camera(0, 0, 800, 480)).setWakeLockOptions(WakeLockOptions.SCREEN_ON);
    ...
    public void onCreateScene(OnCreateSceneCallback pOnCreateSceneCallback) throws IOException {
        ...
        mainScene.setGameManager(gameManager);
        mainScene.onCreate();

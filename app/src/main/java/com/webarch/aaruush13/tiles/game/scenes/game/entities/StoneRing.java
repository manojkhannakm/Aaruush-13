...
public class StoneRing extends Entity {

    public StoneRing(GameManager gameManager, GameScene gameScene, float x, float y, TextureRegion textureRegion) {
    ...
    public void onCreate() {
        ...
        }, new AlphaModifier(0.25f, 1.0f, 0.0f), new ScaleModifier(0.25f, 0.0f, 1.0f)));
    }

package com.webarch.aaruush13.tiles.game.scenes.game;

import com.webarch.aaruush13.tiles.game.Game;
import com.webarch.aaruush13.tiles.game.GameManager;
import com.webarch.aaruush13.tiles.game.scenes.game.entities.Player;
import com.webarch.aaruush13.tiles.game.scenes.game.entities.PlayerProjectile;
import com.webarch.aaruush13.tiles.game.scenes.game.entities.SmallRing;
import com.webarch.aaruush13.tiles.game.scenes.game.entities.Stone;
import com.webarch.aaruush13.tiles.game.scenes.game.entities.StoneRing;
import com.webarch.aaruush13.tiles.game.scenes.game.entities.enemyentites.BlueArrowEnemy;
import com.webarch.aaruush13.tiles.game.scenes.game.entities.enemyentites.GreenArrowEnemy;
import com.webarch.aaruush13.tiles.game.scenes.game.entities.enemyentites.Logo;
import com.webarch.aaruush13.tiles.game.scenes.game.entities.enemyentites.SquareDiamondEnemy;
...
public class EntitySpawner {
    ...
    private TextureRegion gameBackgroundTextureRegion, playerTextureRegion, playerProjectileTextureRegion, smallRingTextureRegion, greenArrowEnemyTextureRegion, blueArrowEnemyTextureRegion, squareDiamondTextureRegion;
    private TextureRegion[] stoneTextureRegions = new TextureRegion[5], stoneRingTextureRegions = new TextureRegion[5], logoTextureRegions = new TextureRegion[10], whiteLogoTextureRegions = new TextureRegion[10];
    ...
    public void onDestroy() {
        gameManager.getGame().runOnUpdateThread(new Runnable() {
            ...
            public void run() {
                ...
                for (Entity entity : new ArrayList<Entity>(EntitySpawner.this.entities)) {
                    destroy(entity);
                }

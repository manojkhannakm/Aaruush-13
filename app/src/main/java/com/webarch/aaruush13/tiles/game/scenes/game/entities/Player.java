package com.webarch.aaruush13.tiles.game.scenes.game.entities;
...
import com.webarch.aaruush13.tiles.game.scenes.game.GameInterface;
...
public class Player extends Entity {
    ...
    public Body onCreateBody() {
        return PhysicsFactory.createCircleBody(gameScene.getPhysicsWorld(), getX(), getY(), getWidth() * 0.4f, BodyDef.BodyType.DynamicBody, PhysicsFactory.createFixtureDef(0.0f, 0.0f, 0.0f, false, GameScene.playerCategoryBit, GameScene.playerMaskBit, (short) 0));
    }

...
import com.webarch.aaruush13.tiles.game.scenes.game.Entity;
...
public class Logo extends Entity {
    ...
    public Logo(GameManager gameManager, GameScene gameScene, float x, float y, int logoId, TextureRegion textureRegion) {
    ...
    public void onCreate() {
        ...
        registerUpdateHandler(new TimerHandler(MathUtils.random(3.0f, 5.0f), new ITimerCallback() {
            ...
            public void onTimePassed(TimerHandler pTimerHandler) {
                ...
                }, new AlphaModifier(0.25f, 1.0f, 0.0f), new ScaleModifier(0.25f, 1.0f, 0.0f)));
            }
    ...
    public void onUpdate() {
        ...
        if (MathUtils.distance(x1, y1, x2, y2) <= 75.0f) {
            ...
            }, new AlphaModifier(0.5f, 1.0f, 0.0f), new MoveModifier(0.5f, x1, y1, x2, y2, EaseQuintOut.getInstance())));

            gameScene.getGameInterface().updatePatternLogos(logoId);
        }
    }

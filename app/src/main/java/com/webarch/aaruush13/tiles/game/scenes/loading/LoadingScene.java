package com.webarch.aaruush13.tiles.game.scenes.loading;
...
public class LoadingScene extends BaseScene {
    ...
    public void onStart() {
        ...
        loadingBarSprite.registerEntityModifier(new SequenceEntityModifier(new DelayModifier(0.2f), new ScaleModifier(0.5f, 0.0f, 1.0f, EaseBackOut.getInstance()), new DelayModifier(MathUtils.random(0.5f, 1.0f), new IEntityModifier.IEntityModifierListener() {

...
public class PlayerProjectile extends Entity {
    ...
    public Body onCreateBody() {
        return PhysicsFactory.createCircleBody(gameScene.getPhysicsWorld(), getX(), getY(), getWidth() * 0.4f, BodyDef.BodyType.KinematicBody, PhysicsFactory.createFixtureDef(0.0f, 0.0f, 0.0f, false, GameScene.otherCategoryBit, GameScene.otherMaskBit, (short) 0));
    }

...
public class CoreTeamPage extends PeopleTileScreenPage {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        RelativeLayout relativeLayout = (RelativeLayout) super.onCreateView(inflater, container, savedInstanceState);

        inflater.inflate(R.layout.credits_coreteam, (LinearLayout) relativeLayout.findViewById(R.id.peoples_layout), true);

package com.webarch.aaruush13.tiles.game.scenes.main;

import android.content.Context;
import android.content.SharedPreferences;

import com.webarch.aaruush13.tiles.game.BaseScene;
import com.webarch.aaruush13.tiles.game.scenes.loading.LoadingScene;
...
public class MainScene extends BaseScene {
    ...
    public void onCreate() {
        ...
        playButtonSprite = new ButtonSprite(cameraHalfWidth, cameraHeight * 0.55f, BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(bitmapTextureAtlas, game, "play.png", 0, 0, 1, 2), vertexBufferObjectManager, new ButtonSprite.OnClickListener() {
            ...
            public void onClick(ButtonSprite pButtonSprite, float pTouchAreaLocalX, float pTouchAreaLocalY) {
                ...
                highscoresButtonSprite.registerEntityModifier(new SequenceEntityModifier(new DelayModifier(0.2f), new ScaleModifier(0.5f, 1.0f, 0.0f, EaseBackIn.getInstance())));

                settingsButtonSprite.registerEntityModifier(new SequenceEntityModifier(new DelayModifier(0.4f), new ScaleModifier(0.5f, 1.0f, 0.0f, EaseBackIn.getInstance())));

                musicButtonSprite.registerEntityModifier(new SequenceEntityModifier(new DelayModifier(0.6f), new ScaleModifier(0.5f, 1.0f, 0.0f, EaseBackIn.getInstance())));

                soundButtonSprite.registerEntityModifier(new SequenceEntityModifier(new DelayModifier(0.6f), new ScaleModifier(0.5f, 1.0f, 0.0f, new IEntityModifier.IEntityModifierListener() {
        ...
        musicButtonSprite = new ButtonSprite(cameraWidth * 0.8f, cameraHeight * 0.15f, BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(bitmapTextureAtlas, game, "music.png", 492, 0, 1, 2), vertexBufferObjectManager, new ButtonSprite.OnClickListener() {
            ...
            public void onClick(ButtonSprite pButtonSprite, float pTouchAreaLocalX, float pTouchAreaLocalY) {
                ...
                preferences.edit().putBoolean("isMusicEnabled", !isMusicEnabled).commit();
            }
        ...
        soundButtonSprite = new ButtonSprite(cameraWidth * 0.9f, cameraHeight * 0.15f, BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(bitmapTextureAtlas, game, "sound.png", 557, 0, 1, 2), vertexBufferObjectManager, new ButtonSprite.OnClickListener() {
            ...
            public void onClick(ButtonSprite pButtonSprite, float pTouchAreaLocalX, float pTouchAreaLocalY) {
                ...
                preferences.edit().putBoolean("isSoundEnabled", !isSoundEnabled).commit();
            }
    ...
    public void onStart() {
        ...
        highscoresButtonSprite.registerEntityModifier(new SequenceEntityModifier(new DelayModifier(0.2f), new ScaleModifier(0.5f, 0.0f, 1.0f, EaseBackOut.getInstance())));

        settingsButtonSprite.registerEntityModifier(new SequenceEntityModifier(new DelayModifier(0.4f), new ScaleModifier(0.5f, 0.0f, 1.0f, EaseBackOut.getInstance())));

        musicButtonSprite.registerEntityModifier(new SequenceEntityModifier(new DelayModifier(0.6f), new ScaleModifier(0.5f, 0.0f, 1.0f, EaseBackOut.getInstance())));

        soundButtonSprite.registerEntityModifier(new SequenceEntityModifier(new DelayModifier(0.6f), new ScaleModifier(0.5f, 0.0f, 1.0f, new IEntityModifier.IEntityModifierListener() {
